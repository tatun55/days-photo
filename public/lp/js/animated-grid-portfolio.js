 ...
 */
{
            ...
            return new Promise((resolve, reject) => {
                ...
                this.DOM.items.forEach((item) => {
                    ...
                    TweenMax.to(item, speed, {
                        ...
                        y: action === 'show' ? item.dataset.cty : direction === 'up' ? `-=${winsize.height + rect.height}` : `+=${winsize.height + rect.height}`
                    });
    ...
    class MenuItem {
        ...
        toggleCurrent(direction = 'up') {
            ...
            // Toggle the link element ("discover").
            TweenMax.to(this.DOM.link, 1, {
                ease: Expo.easeOut,
                startAt: isCurrent ? null : {
                    opacity: 0,
    ...
    class NavController {
        constructor(el) {
            this.DOM = {
                menu: el
            }; // Initialize with the menu element.
        ...
        init() {
            ...
            this.grids[this.current].DOM.items.forEach((item) => TweenMax.set(item, {
                opacity: 1
            }));
