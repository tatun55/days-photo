...
function addHandler(e, t, n, i, s) {
    ...
    const [o, a, r] = normalizeParams(t, n, i), l = getEvent(e), c = l[r] || (l[r] = {}), E = findHandler(c, a, o ? n : null);
...
const EventHandler = {
        ...
        off(e, t, n, i) {
            if ("string" != typeof t || !e) return;
            const [s, o, a] = normalizeParams(t, n, i), r = a !== t, l = getEvent(e), c = t.startsWith(".");
            if (void 0 !== o) {
                if (!l || !l[a]) return;
...
class Carousel extends BaseComponent {
    ...
    _getConfig(e) {
        return e = {
            ...Default$9,
            ...e
        }, typeCheckConfig(NAME$a, e, DefaultType$9), e
    }
    _handleSwipe() {
    ...
    _slide(e, t) {
        ...
        if (this._element.classList.contains("slide")) {
            ...
            const e = () => {
                o.classList.remove(c, E), o.classList.add("active"), i.classList.remove("active", E, c), this._isSliding = !1, setTimeout(d, 0)
            };
            this._queueCallback(e, i, !0)
        } else i.classList.remove("active"), o.classList.add("active"), this._isSliding = !1, d();
        r && this.cycle()
    }
    _directionToCartItem(e) {
...
EventHandler.on(document, EVENT_CLICK_DATA_API$5, SELECTOR_DATA_SLIDE, Carousel.dataApiClickHandler), EventHandler.on(window, EVENT_LOAD_DATA_API$2, () => {
    ...
    for (let t = 0, n = e.length; t < n; t++) Carousel.carouselInterface(e[t], Data.get(e[t], DATA_KEY$9))
...
class Collapse extends BaseComponent {
    ...
    show() {
        ...
        this._queueCallback(() => {
            this._element.classList.remove("collapsing"), this._element.classList.add("collapse", "show"), this._element.style[i] = "", this.setTransitioning(!1), EventHandler.trigger(this._element, EVENT_SHOWN$5)
    ...
    hide() {
        ...
        this.setTransitioning(!0), this._element.style[e] = "", this._queueCallback(() => {
            this.setTransitioning(!1), this._element.classList.remove("collapsing"), this._element.classList.add("collapse"), EventHandler.trigger(this._element, EVENT_HIDDEN$5)
        }, this._element, !0)
    }
    setTransitioning(e) {
    ...
    _getConfig(e) {
        return (e = {
            ...Default$8,
            ...e
        }).toggle = Boolean(e.toggle), typeCheckConfig(NAME$9, e, DefaultType$8), e
    }
    _getDimension() {
...
class Dropdown extends BaseComponent {
    ...
    _getConfig(e) {
        if (e = {
                ...
                ...e
            }, typeCheckConfig(NAME$8, e, this.constructor.DefaultType), "object" == typeof e.reference && !isElement(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError(NAME$8.toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
        return e
    }
    _getMenuElement() {
    ...
    static dataApiKeydownHandler(e) {
        ...
        const n = () => this.matches(SELECTOR_DATA_TOGGLE$3) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0];
...
const SELECTOR_FIXED_CONTENT = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    ...
    hide = (e = getWidth()) => {
        _disableOverFlow(), _setElementAttributes("body", "paddingRight", t => t + e), _setElementAttributes(SELECTOR_FIXED_CONTENT, "paddingRight", t => t + e), _setElementAttributes(".sticky-top", "marginRight", t => t - e)
    },
    _disableOverFlow = () => {
...
class Backdrop {
    ...
    _getConfig(e) {
        return (e = {
            ...
            ...
            "object" == typeof e ? e : {}
        }).rootElement = e.rootElement || document.body, typeCheckConfig(NAME$7, e, DefaultType$6), e
    }
    _append() {
        this._isAppended || (this._config.rootElement.appendChild(this._getElement()), EventHandler.on(this._getElement(), EVENT_MOUSEDOWN, () => {
    ...
    _emulateAnimation(e) {
        ...
        EventHandler.one(this._getElement(), "transitionend", () => execute(e)), emulateTransitionEnd(this._getElement(), t)
    }
}
const NAME$6 = "modal",
    DATA_KEY$6 = "bs.modal",
...
class Modal extends BaseComponent {
    constructor(e, t) {
        super(e), this._config = this._getConfig(t), this._dialog = SelectorEngine.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1
    }
    static get Default() {
        return Default$5
    }
    ...
    show(e) {
        ...
        this._isShown || t.defaultPrevented || (this._isShown = !0, hide(), document.body.classList.add("modal-open"), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), EventHandler.on(this._element, EVENT_CLICK_DISMISS$2, SELECTOR_DATA_DISMISS$2, e => this.hide(e)), EventHandler.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, () => {
    ...
    _showElement(e) {
        ...
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.scrollTop = 0, n && (n.scrollTop = 0), t && reflow(this._element), this._element.classList.add("show"), this._config.focus && this._enforceFocus(), this._queueCallback(() => {
            this._config.focus && this._element.focus(), this._isTransitioning = !1, EventHandler.trigger(this._element, EVENT_SHOWN$3, {
                relatedTarget: e
            })
        }, this._dialog, t)
    }
    _enforceFocus() {
        EventHandler.off(document, EVENT_FOCUSIN$2), EventHandler.on(document, EVENT_FOCUSIN$2, e => {
    ...
    _hideModal() {
        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
            document.body.classList.remove("modal-open"), this._resetAdjustments(), reset(), EventHandler.trigger(this._element, EVENT_HIDDEN$3)
        })
    }
    _showBackdrop(e) {
    ...
    _triggerBackdropTransition() {
        ...
        EventHandler.off(this._element, "transitionend"), EventHandler.one(this._element, "transitionend", () => {
            this._element.classList.remove("modal-static"), e || (EventHandler.one(this._element, "transitionend", () => {
...
class Offcanvas extends BaseComponent {
    ...
    hide() {
        this._isShown && (EventHandler.trigger(this._element, EVENT_HIDE$2).defaultPrevented || (EventHandler.off(document, EVENT_FOCUSIN$1), this._element.blur(), this._isShown = !1, this._element.classList.remove("show"), this._backdrop.hide(), this._queueCallback(() => {
            this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || reset(), EventHandler.trigger(this._element, EVENT_HIDDEN$2)
        }, this._element, !0)))
    }
    dispose() {
    ...
    _enforceFocusOnElement(e) {
        EventHandler.off(document, EVENT_FOCUSIN$1), EventHandler.on(document, EVENT_FOCUSIN$1, t => {
            document === t.target || e === t.target || e.contains(t.target) || e.focus()
        }), e.focus()
    }
    _addEventListeners() {
        EventHandler.on(this._element, EVENT_CLICK_DISMISS$1, SELECTOR_DATA_DISMISS$1, () => this.hide()), EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS, e => {
...
EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, (function(e) {
    ...
    SelectorEngine.find(OPEN_SELECTOR).forEach(e => (Data.get(e, DATA_KEY$5) || new Offcanvas(e)).show())
...
class Tooltip extends BaseComponent {
    ...
    dispose() {
        clearTimeout(this._timeout), EventHandler.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.tip && this.tip.parentNode && this.tip.parentNode.removeChild(this.tip), this._popper && this._popper.destroy(), super.dispose()
    }
    show() {
    ...
    hide() {
        ...
        this._queueCallback(() => {
            this._isWithActiveTrigger() || ("show" !== this._hoverState && e.parentNode && e.parentNode.removeChild(e), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), EventHandler.trigger(this._element, this.constructor.Event.HIDDEN), this._popper && (this._popper.destroy(), this._popper = null))
...
class ScrollSpy extends BaseComponent {
    ...
    _activate(e) {
        ...
        n.classList.contains("dropdown-item") ? (SelectorEngine.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active")) : (n.classList.add("active"), SelectorEngine.parents(n, ".nav, .list-group").forEach(e => {
    ...
    _clear() {
        SelectorEngine.find(this._selector).filter(e => e.classList.contains("active")).forEach(e => e.classList.remove("active"))
    }
    static jQueryInterface(e) {
        return this.each((function() {
...
class Tab extends BaseComponent {
    ...
    show() {
        ...
        const i = e ? EventHandler.trigger(e, EVENT_HIDE$1, {
            relatedTarget: this._element
        }) : null;
...
class Toast extends BaseComponent {
    ...
    show() {
        EventHandler.trigger(this._element, EVENT_SHOW).defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), reflow(this._element), this._element.classList.add("showing"), this._queueCallback(() => {
            this._element.classList.remove("showing"), this._element.classList.add("show"), EventHandler.trigger(this._element, EVENT_SHOWN), this._maybeScheduleHide()
        }, this._element, this._config.animation))
    }
    hide() {
        this._element.classList.contains("show") && (EventHandler.trigger(this._element, EVENT_HIDE).defaultPrevented || (this._element.classList.remove("show"), this._queueCallback(() => {
