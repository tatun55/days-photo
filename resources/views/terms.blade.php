            ...
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card shadow border-gray-300 p-4 p-lg-5">
                        <p>この利用規約（以下，「本規約」といいます。）は，<a href="https://colorbox.tech" style="font-size: 15px" class="p-0" target="_blank" rel="noopener noreferrer">COLORBOX株式会社</a>（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

                        <h5 class="pt-4 pb-2">第1条（適用）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第2条（利用登録）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第3条（ユーザーIDおよびパスワードの管理）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第4条（利用料金および支払方法）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第5条（禁止事項）</h5>
                        ...
                        <h5 class="pt-4 pb-2">第6条（本サービスの提供の停止等）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第7条（利用制限および登録抹消）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第8条（退会）</h5>
                        <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>

                        <h5 class="pt-4 pb-2">第9条（保証の否認および免責事項）</h5>
                        <ol>
                        ...
                        <h5 class="pt-4 pb-2">第14条（権利義務の譲渡の禁止）</h5>
                        <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>

                        <h5 class="pt-4 pb-2">第15条（準拠法・裁判管轄）</h5>
                        <ol>
