    ...
    <div class="section section-lg pt-5 pt-md-6">
        <div class="container">
            <div class="row pt-4 pt-md-0">
                ...
                <div class="mx-2"><small><span class="text-danger">*</span> ぜひアンケートへの回答をお願いします ( <a class="text-gray-600 text-decoration-underline" href="https://forms.gle/AeQLv4qGNQkbNfDy9" target="_blank" rel="noopener noreferrer">アンケートに回答</a>)</small></div>
