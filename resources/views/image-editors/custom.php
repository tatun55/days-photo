...
<body>
    ...
    <!-- <script type="text/javascript" src="tui-image-editor/js/tui-image-editor-custom.js"></script> -->
    ...
    <!-- <script type="text/javascript" src="tui-image-editor/js/service-basic-custom.js"></script> -->
    <script>
    // Image editor
